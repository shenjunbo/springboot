package com.mazhq.web.strategy;

import com.dangdang.ddframe.rdb.sharding.api.ShardingValue;
import com.dangdang.ddframe.rdb.sharding.api.strategy.database.SingleKeyDatabaseShardingAlgorithm;
import com.google.common.collect.Range;
import com.mazhq.web.conf.Database0Config;
import com.mazhq.web.conf.Database1Config;
 ...
 * @Description: TODO
 * @date 2019/8/1 17:09
 * 用什么列进行分库以及分库算法 （一般是用具体值对2取余判断入哪个库，我采用的是判断值是否大于20）
 */
@Component
